...
setwd("~/GitHub/biglasso_experiment/real_data/GWAS/20170203_res_kdd/")
load("~/GitHub/biglasso_experiment/real_data/GWAS/Data.RData")
backingfile <- '~/GitHub/biglasso_experiment/real_data/GWAS/back.bin'
descrpfile <- '~/GitHub/biglasso_experiment/real_data/GWAS/descrb.desc'
